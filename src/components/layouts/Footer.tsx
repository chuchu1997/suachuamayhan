    ...
    <footer className="bg-gradient-to-b from-[#333333] to-gray-900 text-gray-200 py-12 shadow-lg">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="space-y-1 mt-4 text-xs md:text-sm lg:text-md">
        ...
        <div className="flex justify-center space-x-4 mt-10">
          <a href="/" className="bg-gray-700 p-2 rounded-full text-accent hover:bg-accent hover:text-white transition-all duration-300">
